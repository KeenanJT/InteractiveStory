...
//  InteractiveStory
//
//  Created by Keenan Turner on 8/2/16.
//  Copyright © 2016 Keenan Turner. All rights reserved.
//

import Foundation
import UIKit

enum Story: String { // all are particular segments of the story
    case ReturnTrip
    case TouchDown
    case Homeward
    case Rover
...
struct Adventure {
    static var adventure: Page {
        ...
        let rover = touchdown.addChoice("Explore the Rober", story: .Rover)
